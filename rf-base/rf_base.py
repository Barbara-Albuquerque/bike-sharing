...
# Configuração
output_dir = "rf-base/results"
os.makedirs(output_dir, exist_ok=True)


# 1. Dados
df = pd.read_csv("SeoulBikeData_original.csv", encoding="utf-8")
...
plt.savefig(
    os.path.join(output_dir, "rf_base_step2_pred_vs_true_train_test.png"),
    dpi=300,
    bbox_inches="tight"
)
...
df_treino.to_csv(
    os.path.join(output_dir, "rf_base_step2_treino.csv"),
    index=False
)
...
df_teste.to_csv(
    os.path.join(output_dir, "rf_base_step2_teste.csv"),
    index=False
)

print("\nArquivos salvos: rf_base_step2_treino.csv e rf_base_step2_teste.csv")
...
df_medias.to_csv(
    os.path.join(output_dir, "rf_base_step2_medias.csv"),
    index=False
)

print("Arquivo de médias salvo: rf_base_step2_medias.csv")
...
df_preds.to_csv(
    os.path.join(output_dir, "rf_base_step2_preds.csv"),
    index=False
)

print("Arquivo de previsões salvo: rf_base_step2_preds.csv")
...
df_importances.to_csv(
    os.path.join(output_dir, "rf_base_feature_importance.csv"),
    index=False
)

print("Arquivo de feature importance salvo: rf_base_feature_importance.csv")
...
plt.savefig(
    os.path.join(output_dir, "rf_base_feature_importance.png"),
    dpi=300,
    bbox_inches="tight"
)
